...
function _window_location_assign_(str) {
 window.location.assign(Pointer_stringify(str));
}

function _window_location_href_(str) {
...
var asmLibraryArg = {
 ...
 "time": _time,
 "utime": _utime,
 "window_location_assign_": _window_location_assign_,
 "window_location_href_": _window_location_href_
};
...
var dynCall_viiiiifffffifiiffi = Module["dynCall_viiiiifffffifiiffi"] = createExportWrapper("dynCall_viiiiifffffifiiffi");
...
var dynCall_viififiiffi = Module["dynCall_viififiiffi"] = createExportWrapper("dynCall_viififiiffi");
